...
MAX_NUMBER_OF_TEAMS = 4                -- How many potential teams can be in this game mode? -- Four.
USE_CUSTOM_TEAM_COLORS = true          -- Should we use custom team colors? -- Yes.
USE_CUSTOM_TEAM_COLORS_FOR_PLAYERS = true          -- Should we use custom team colors to color the players/minimap? -- Yes.

TEAM_COLORS = {}                        -- If USE_CUSTOM_TEAM_COLORS is set, use these colors.
TEAM_COLORS[DOTA_TEAM_GOODGUYS] = { 255, 224, 192 }  --    White for Air
TEAM_COLORS[DOTA_TEAM_BADGUYS]  = { 255, 64, 96 }   --    Red for Fire
TEAM_COLORS[DOTA_TEAM_CUSTOM_1] = { 64, 96, 255 }  --    Blue for Water
TEAM_COLORS[DOTA_TEAM_CUSTOM_2] = { 96, 255, 64 }   --    Green for Earth
TEAM_COLORS[DOTA_TEAM_CUSTOM_3] = { 100, 100, 100 }   --    Grey for unused
TEAM_COLORS[DOTA_TEAM_CUSTOM_4] = { 100, 100, 100 }  --    Grey for unused
TEAM_COLORS[DOTA_TEAM_CUSTOM_5] = { 100, 100, 100 }   --    Grey for unused
TEAM_COLORS[DOTA_TEAM_CUSTOM_6] = { 100, 100, 100 }  --    Grey for unused
TEAM_COLORS[DOTA_TEAM_CUSTOM_7] = { 100, 100, 100 }  --    Grey for unused
TEAM_COLORS[DOTA_TEAM_CUSTOM_8] = { 100, 100, 100 }  --    Grey for unused
